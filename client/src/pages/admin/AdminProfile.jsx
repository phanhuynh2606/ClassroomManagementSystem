...
const AdminProfile = () => {
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      setUser(prev => ({ ...prev, image: res.imageUrl }));
      setPreviewImage('');
        ...
        <Row align="middle" style={{ padding: '24px 32px 24px 32px' }}>
          ...
          <Col span={18}>
            <div style={{ marginLeft: 32 }}>
              <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 2 }}>{user?.fullName}</h1>
          ...
          <Row gutter={32}>
            <Col span={12}>
              ...
              >
                ...
                >
                  <Form.Item name="fullName" label={<span style={{ fontWeight: 500 }}>Full Name</span>}>
                    <Input size="large" />
                  </Form.Item>
                  <Form.Item name="phone" label={<span style={{ fontWeight: 500 }}>Phone Number</span>}>
                    <Input size="large" />
                  </Form.Item>
                  <Form.Item name="dateOfBirth" label={<span style={{ fontWeight: 500 }}>Date of Birth</span>}>
                    <DatePicker style={{ width: '100%' }} format="YYYY-MM-DD" size="large" />
                  </Form.Item>
                  <Form.Item name="gender" label={<span style={{ fontWeight: 500 }}>Gender</span>}>
                    <Select allowClear placeholder="Select gender" size="large">
