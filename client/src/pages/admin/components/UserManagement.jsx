...
const UserManagement = () => {
  ...
  const handleVerifyTeacher = async (userId, verify) => {
    try {
      ...
      message.success(
        `Teacher ${verify ? "verified" : "unverified"} successfully`
      );
    } catch (error) {
          ...
          <Row style={{ marginTop: 16 }}>
            <Col>
              <Space>
                ...
                <Button
                  type={
                    filters.verificationStatus === true ? "primary" : "default"
                  }
                ...
                <Button
                  type={
                    filters.verificationStatus === false ? "primary" : "default"
                  }
                  onClick={() =>
                    handleFilterChange("verificationStatus", false)
                  }
                >
                  Unverified Teachers
                </Button>
